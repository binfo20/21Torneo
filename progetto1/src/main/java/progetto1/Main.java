...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
       ...
       for(int i=0; i<fase1.n_part; i++) fase1.a.add(i, new partecipante());
       ...
       if("y".equals(risposta)){
           ...
           while(true) {
               ...
               s_id1=br.readLine();
               if(s_nome==null || s_cognome==null || s_id1==null)break;
               fase1.a.get(s_posizione).nome=s_nome;
               fase1.a.get(s_posizione).cognome=s_cognome;
               int s_id2 = Integer.parseInt(s_id1);
               fase1.a.get(s_posizione).id=s_id2;
               s_posizione++;
           }   
       }
       else{
       ...
       for(int l=0; l<fase1.part_max; l++){
           b.write(fase1.a.get(l).nome + "\n" + fase1.a.get(l).cognome + "\n"+fase1.a.get(l).id);
           b.write("\n");
       }
       b.flush();
    ...
    while(true) {
      ...
      while(fase1.n_part!=1){
          ...
          if((fase1.n_part % 2) !=0 && fase1.n_part!=1) fase1.n_part++;
